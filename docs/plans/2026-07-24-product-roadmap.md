...
| C   | Paridad de features: `edit-image` y `generate-video`, ejemplos precargados por modelo, share-by-URL, snippets de código multi-lenguaje (cURL/JS/Python) en la pestaña API, historial de generaciones de la sesión y descarga del resultado | implementada; smoke live de pago pendiente | B          |
| D   | Polish: a11y (axe), QA, presupuesto de bundle, deploy (Pages + Workers) e integración como caso de estudio                                                                                                                                 | bloqueada por cierre de C                  | C          |
